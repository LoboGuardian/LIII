    ...
    , m_fastresumeLastSaved(QDateTime::currentDateTimeUtc())
{
    ...
    VERIFY(connect(dlcModel, &DownloadCollectionModel::signalDeleteURLFromModel, this, &TorrentManager::on_deleteTaskWithID));
    VERIFY(connect(dlcModel, &DownloadCollectionModel::signalPauseDownloadItemWithID, this, &TorrentManager::on_pauseTaskWithID));
